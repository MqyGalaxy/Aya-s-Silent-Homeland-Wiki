...
import ayaImg from '../assets/images/game/文文_人物剪影.png';
import momijiImg from '../assets/images/game/椛椛_人物剪影.png';
import nueImg from '../assets/images/game/鵺鵺_人物剪影.png';
import reisenImg from '../assets/images/game/铃仙_人物剪影.png';
...
export const characters: Character[] = [
    ...
    },
    {
        ...
        nameEn: 'HOUJUU NUE',
        role: '赌场老千 // 潜行型',
        desc: '正体不明的妖怪，也许正因为其原本的能力所积累的经验，在如今怪异横行的幻想乡中依旧能够来去自如。鬼犄异变影响了许多人与妖怪，但像封兽鵺这样依旧能够享受当下的存在可不多见。',
